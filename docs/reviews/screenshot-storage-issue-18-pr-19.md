...
- **516 full-suite Swift tests passed:** 318 XCTest and 198 Swift Testing tests. Additional focused coverage included **106 tests:** 96 covering storage, annotation round trips, image cleanup, leases, settings, and exports; 10 covering worktree server selection and plugin-version consistency.
